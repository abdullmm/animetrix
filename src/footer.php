...
<script>
    ...
    function populate() {
        document.getElementById('txtFirstname').value = "Carey";
        document.getElementById('txtLastname').value = "Cole";
        document.getElementById('txtPhone').value = "5401234567";
        document.getElementById('txtEmail').value = "colecb@jmu.edu";
        document.getElementById('txtUserName').value = "colecb";
        return false;
    }
